...
export function LoginPage() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // بعد از ۱ ثانیه به صفحه اصلی برو
      setTimeout(() => {
        navigate("/");
      }, 1000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-gray-900 to-[#FA6320] flex items-center justify-center p-4 font-vazir">
      <div className="rounded-3xl shadow-lg overflow-hidden w-full max-w-4xl grid md:grid-cols-2">
        {/* تصویر سمت چپ */}
